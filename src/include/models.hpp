...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_test");
    reader.add_event(10, 10, "end", "model_test");
    return reader;
}

class model_test : public prob_grad {
private:
    int N;
    vector<int> y;
public:
    model_test(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_test_namespace::model_test";
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "model_test_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
